...
struct input_dev* ctp_gesture_get_input_device(void)
{
	...
	printk("%s\n", __func__);
	return pdata->input_device;
}
EXPORT_SYMBOL_GPL(ctp_gesture_get_input_device);
#endif
				...
				struct device_attribute *attr, char *buf)
{
	...
	pdata->current_gesture_val = 0;		// Clean gesture data.
...
static Func_Ctp_Gesture_Mode Func_ctp_gesture_switch = NULL;
...
static Func_Ctp_Cover_State Func_ctp_cover_state = NULL;
