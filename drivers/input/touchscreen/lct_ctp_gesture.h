...
// defined for Meizu	Begin.
#define GESTURE_ERROR	0x00
/* Double tap */
#define DOUBLE_TAP		0xA0
/* Swipe */
#define SWIPE_X_LEFT	0xB0	// swipe to left
#define SWIPE_X_RIGHT	0xB1	// swipe to right
#define SWIPE_Y_UP		0xB2	// up
#define SWIPE_Y_DOWN	0xB3	// down
/* Unicode */
...
//Swipe
#define BIT_SWIPE_RIGHT	(1<<0)		// 0x00000001
#define BIT_SWIPE_LEFT	(1<<1)		// 0x00000002
#define BIT_SWIPE_DOWN	(1<<2)		// 0x00000004
#define BIT_SWIPE_UP	(1<<3)		// 0x00000008
//Tap
#define BIT_DOUBLE_TAP	(1<<8)		// 0x00000100
// Unicode
#define BIT_UNICODE_E	(1<<16)		// 0x00010000
#define BIT_UNICODE_C	(1<<17)		// 0x00020000
#define BIT_UNICODE_W	(1<<18)		// 0x00040000
#define BIT_UNICODE_M	(1<<19)		// 0x00080000
#define BIT_UNICODE_O	(1<<20)		// 0x00100000
#define BIT_UNICODE_S	(1<<21)		// 0x00200000
#define BIT_UNICODE_V	(1<<22)		// 0x00400000
#define BIT_UNICODE_Z	(1<<23)		// 0x00800000
// Status
#define BIT_STATUS_OFF	(0<<0)		// 0x00000000
#define BIT_STATUS_ALL	(1<<24)		// 0x01000000
#define BIT_STATUS_PART	(1<<28)		// 0x10000000
